(function () {
  ...
  const dictionaries = {
    "zh-CN": {
      ...
      "event.retry": "重试",
      "event.finished": "结束",
      "event.field.arguments": "参数",
      "event.field.status": "状态",
      "event.field.stopReason": "停止原因",
      "event.field.toolCallId": "调用 ID",
      "event.field.usage": "用量",
    ...
    en: {
      ...
      "task.resume": "Resume",
      "task.delete": "Delete",
      "task.deleteConfirmInline": "Confirm delete?",
      "task.id": "Task ID",
      ...
      "event.field.arguments": "Args",
      "event.field.status": "Status",
      "event.field.stopReason": "Stop reason",
      "event.field.toolCallId": "Call ID",
      "event.field.usage": "Usage",
